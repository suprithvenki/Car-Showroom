...
<li class="nav-item">
  ...
  <div class="row">
          ...
          <div class="form-group">
            ...
            <input type="text" name="amount" class="form-control" required="">
  				...
  				<button class="btn btn-primary" name="add_spec">Add bill</button>
  ...
  if(isset($_POST['add_spec'])){
    ...
    $query = "insert into spec values(null,$_POST[id],'$_POST[seater]','$_POST[mileage]','$_POST[fuel]','$_POST[topspeed]','$_POST[amount]')";
    $query_run = mysqli_query($connection,$query);
  ?>
  <script type="text/javascript">
    alert("added car successfully");
    window.location.href = "gbill.php";
  </script>
  <?php }
   ?>
