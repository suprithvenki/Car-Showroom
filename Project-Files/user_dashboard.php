	...
	<div class="row">
		<div class="col-md-3">
			...
			<div class="card bg-light" style="width: 300px">
				...
				<div class="card-body">
					<p class="card-text"> </p>
					<a href="user_bookedcar.php" class="btn btn-success" target="_blank">View booked cars</a>
				</div>
			</div>
		</div>
		<div class="col-md-3">
			<div class="card bg-light" style="width: 300px">
				...
				<div class="card-body">
					<p class="card-text"> </p>
					<a href="user_specscar.php" class="btn btn-success" target="_blank">View Specs of booked cars</a>
				</div>
			</div>
		</div>
		...
		<div class="col-md-3">
			<div class="card bg-light" style="width: 300px">
				...
				<div class="card-body">
					<p class="card-text"> </p>
					<a href="user_bill.php" class="btn btn-success" target="_blank">View Bill of booked cars</a>
				</div>
			</div>
		</div>
	</div>
