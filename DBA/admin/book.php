  ...
  <div class="row">
    ...
    <div class="col-md-4">
      <form action="" method="post">
        ...
        <div class="form-group">
          <label>date</label>
          <input type="date" name="dateofbooking" class="form-control" required="">
        </div>
...
if (isset($_POST['add_spec'])) {
  ...
  $query = "insert into booking values(null,'$_POST[id]','$_POST[carname]','$_POST[carmodel]','$_POST[dateofbooking]')";
  $query_run = mysqli_query($connection, $query);
?>
  <script type="text/javascript">
    alert("added car successfully");
    window.location.href = "spec.php";
  </script>
<?php }
?>