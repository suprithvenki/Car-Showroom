...
$query = "select bill.billid,bill.dateofbilling,bill.amount ,register.name from bill left join register on
	bill.id = register.id";
?>
<!DOCTYPE html>
			...
			<form>
				<table class="table-bordered" width="900px" style="text-align: center">
					...
					while ($row = mysqli_fetch_assoc($query_run)) {
						...
						$amount = $row['amount'];
						$dateofbilling = $row['dateofbilling'];
